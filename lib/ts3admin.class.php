...
/**
  ...
  */
    ...
    $str = "";
    if ($conv_time['days'] > 0) $str .= $conv_time['days'] . ' ' . ($conv_time['days'] == 1 ? "dzień " : "dni ");
    if ($conv_time['hours'] > 0) $str .= $conv_time['hours'] . ' ' . ($conv_time['hours'] == 1 ? "godzina " : "godzin ");  
    if ($conv_time['minutes'] > 0) $str .= $conv_time['minutes'] . ' ' . ($conv_time['minutes'] == 1 ? "minuta" : "minut");
...
/**
  ...
  */
    ...
    foreach ($this->runtime['debug'] as $fail) {
      echo $fail, PHP_EOL;
    }
